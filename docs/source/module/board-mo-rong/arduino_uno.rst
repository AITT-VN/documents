...
- **Bước 2**: Kết nối Grover - Đèn LED đơn với cổng A2
- **Bước 3**: Kết nối Grover - Nút nhấn đơn với cổng A3
...
.. code-block:: guess
    ...
    const int button = A3;    // connect a button
    const int LED = A2;       // connect a buzzer
    void setup()
    {
