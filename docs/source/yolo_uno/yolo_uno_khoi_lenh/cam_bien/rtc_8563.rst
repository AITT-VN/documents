...
Đầu tiên chúng ta sẽ khởi tạo module RTC bằng cách cài đặt thời gian vào cho module trước (chỉ cần khởi tạo thời gian 1 lần - khi chạy lại chương trình nên xóa bỏ lệnh khởi tạo để thời gian chạy đúng theo cài đặt lần đầu tiên)
