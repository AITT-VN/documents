2. Thiết lập vị trí của nhân vật 
==============================
...
Bạn hãy tải chương trình xuống Game Kit và quan sát vị trí của sprite. Bằng cách xác định vị trí của các nhân vật trong trò chơi, bạn hoàn toàn có thể tự tay tạo ra một khung cảnh với cây cối, nhà cửa, cảnh vật trong trò chơi của mình.
