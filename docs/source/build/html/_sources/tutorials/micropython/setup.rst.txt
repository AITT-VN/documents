...
``Bước 1``: Nhâp vào `đây <https://www.python.org/downloads>`_ để tải file cài đặt Python.

  .. image:: images/ls-0-1.png
    :width: 480
    :align: center

``Bước 2``: Nháy đúp chuột vào file vừa tải về để tiến hành cài đặt.

  .. image:: images/ls-0-2.png
    :width: 480
    :align: center

``Bước 3``: Chọn Add Python 3.7 to PATH, sau đó Install Now

  .. image:: images/ls-0-3.png
    :width: 480
    :align: center
  ...
  .. image:: images/ls-0-4.png
    :width: 480
    :align: center

``Bước 4``: Khi hoàn tất, bạn sẽ thấy thông báo Setup was successful.

  .. image:: images/ls-0-5.png
    :width: 480
    :align: center

  Tiếp theo, nhấp vào `đây <https://randomnerdtutorials.com/uPyCraftWindows>`_ để tải xuống uPyCraft IDE cho Windows.

  .. image:: images/ls-0-6.png
    :width: 480
    :align: center
